...
/**
 * getKey
 * @param {Object} index the index from which to get the value
 * Return: The value of item in the hash
 */
Hashtable.prototype.getKey = function (index){
	try {
...
/**
 * getKeys
 * Return: All the keys in the hash
 */
...
/**
 * getValues
 * Return: All the values in the hash
 */
...
/**
 * getValueFromIndex return the value on the specified position
 * @param {Object} index the index from which to get the value
 */
Hashtable.prototype.getValueFromIndex = function (index){
	return this.hash[this.keys[index]];
}

Hashtable.prototype.getKeyFromIndex = function (index){
	return this.keys[index];
}
...
/**
 * clear
 * removes all items in the layer
 */
